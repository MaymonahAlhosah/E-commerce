                    ...
                    <div className="mb-4">
                       {/** <h4 className="bold-16">Select Size:</h4>
                        ...
                        <div className="flex flex-col gap-y-3 mb-4 max-w-[555px]">
                            <button onClick={() => {addToCart(product.id)}} className="btn_dark_outline !rounded-none uppercase regular-14 tracking-widest">اضف الى سلة التسةق</button>
                            <button className="btn_dark_rounded !rounded-none uppercase regular-14 tracking-widest">اشتر المنتج الان</button>
                        </div>
